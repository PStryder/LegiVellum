...
Vellum is designed to work with LegiVellum's core primitives:

| Primitive | Vellum Role |
|-----------|-------------|
| **ReceiptGate** | Canonical receipt ledger (MemoryGate profile) |
...
Receipts are the coordination protocol and are stored in ReceiptGate.
...
# LegiVellum modules
LegiVellum.Receipt    Receipt types and operations (ReceiptGate integration)
